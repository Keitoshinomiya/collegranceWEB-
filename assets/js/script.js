...
/* =========================================================================
   ...
   - 商品カードに data-product-id="..." がついていれば、articles.js の
     journalArticles から relatedProducts を逆引きしてカード末尾に挿入する。
   - 1記事 → 直接遷移する英日二段見出し
   - 2記事以上 → カード内ポップオーバー（タップ／クリックで開閉）
   ========================================================================= */
(function initJournalLinks() {
    ...
    function attachJournalLinks() {
        ...
        document.querySelectorAll('.product-card-simple[data-product-id]').forEach(function (card) {
            // 既に挿入済みなら何もしない
        ...
        document.addEventListener('click', function (e) {
            ...
            if (close) {
                ...
                if (stamp2) {
                    ...
                    var card2 = stamp2.closest('.product-card-simple');
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', attachJournalLinks);
    } else {
        attachJournalLinks();
    }
})();
