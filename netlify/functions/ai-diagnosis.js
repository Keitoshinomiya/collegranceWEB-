...
⚠️ 最重要ルール（絶対厳守）:
- 推薦する3本は「必ず」上記カタログに記載されている商品のみから選ぶこと
- カタログに存在しない商品（Acqua di Parma、Creed、Tom Ford Tobacco Vanille等）は絶対に推薦しないこと
- productIdはカタログに記載されているid番号を正確に使うこと
- カタログにない商品を推薦した場合、お客様が購入できないため信頼を失う
